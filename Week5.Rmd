...
![](Images/OneSampleT.png){width=75%}
...
### Independent Samples t-test {.well}
...
The above $t$-value falls within our 95% confidence interval, meaning that the result is not statistically significant enough for us to reject the null hypothesis.
