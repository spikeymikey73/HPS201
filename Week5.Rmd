...
-   Since the calculated t-value is greater than the critical t-value, we can reject the null hypothesis. The changes in impulsiveness over time were significant.
...
The calculated $t$-value of 1.79 is less than our critical t-value (from a table) of ???, which falls within our 95% confidence interval, meaning that the result is not statistically significant enough for us to reject the null hypothesis.
...
The calculated $t$-value of 2.45 is greater than our critical t-value (from a table) of ???, which falls outside our 95% confidence interval, meaning that the result is statistically significant enough for us to reject the null hypothesis.
