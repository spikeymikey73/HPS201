...
<table class="table table-hover">
    ...
    <tr scope="row">
        <td>Treatment</td>
        <td><abbr title="k = no. of participants per group">$k-1$</abbr></td>
        <td><abbr title="n = no. of groups">$n\Sigma(\bar{X}_{j}-\bar{X}..)^2$</abbr></td>
    ...
    <tr scope="row">
        <td>Error</td>
        <td><abbr title="k = no. of participants per group, n = no. of groups">$k(n-1)$</abbr></td>
