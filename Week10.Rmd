...
### ANOVA Summary Table (Formulae) {.well}
...
<table class="table table-hover">
  ...
  <tr scope="row">
    <td>Factor A</td>
    <td>1</td>
    <td>$nb\Sigma(\bar{X}_A - \bar{X}..)^2$</td>
    <td>0.34</td>
    <td>0.34</td>
    <td></td>
  </tr>
  <tr scope="row">
    <td>Factor B</td>
    <td>1</td>
    <td>$na\Sigma(\bar{X}_A - \bar{X}..)^2$</td>
    <td>12</td>
    <td>12</td>
    <td></td>
  </tr>
  ...
  <tr scope="row">
    <td><abbr title="$N-1$">Total</td>
    <td>$df_a + df_b + df_{ab} + df_{error}$</td>
