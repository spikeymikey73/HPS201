...
<table class="table table-hover">
  ...
  <tr scope="row">
    <td>Factor A</td>
    <td>$k-1$</td>
    <td><abbr title="n = No. of participants per grp, b = No. of levels in B">$nb\Sigma(\bar{X}_A - \bar{X}..)^2$<abbr></abbr></td>
    <td>0.34</td>
    <td>0.34</td>
    <td></td>
  </tr>
  <tr scope="row">
    <td>Factor B</td>
    <td>$k-1$</td>
    <td><abbr title="n = No. of participants per grp, a = No. of levels in A">$na\Sigma(\bar{X}_A - \bar{X}..)^2$</abbr></td>
    <td>12</td>
    <td>12</td>
    <td></td>
  </tr>
  ...
  <tr scope="row">
    <td>Total</td>
    <td>$N-1$</td>
    <td>$\Sigma(X-\bar{X}..)^2$</td>
  </tr>
    <td colspan="6">$SS_{cells} = n\Sigma(\bar{X}_A - \bar{X}..)^2$</td>
  <tr>
  </tr>
</table>
